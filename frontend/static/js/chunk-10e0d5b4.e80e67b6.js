    ...
    a55b: function (e, n, r) {
      ...
      var o = r("1da1"),
        ...
        l = {
          ...
          computed: Object(s["a"])({}, Object(d["c"])(["currentUserApiKey"])),
          mounted: function () {
            this.handleLogin();
          },
          methods: {
                      ...
                      while (1)
                        switch ((e.prev = e.next)) {
                          ...
                          case 6:
                            return (
                              (a = t.data.user),
                              (i = new c["AvatarGenerator"]()),
                              (o = i.generateRandomAvatar(a.id)),
                              this.$store.dispatch("setLoginInfo", {
                                ...
                                profile: {
                                  ...
                                  pic_full: o,
                                  pic_cover:
                                    "https://i.ibb.co/0G5ny1g/1500x500.jpg",
                                  description: "😎😎",
                                  nickname: a.name,
                                  name: a.name,
